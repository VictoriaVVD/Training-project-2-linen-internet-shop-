                ...
                <div className="article__card">
                    ...
                    <div className="article__info">
                        ...
                        <div className="article__info_char">
                            <Link className="article__info_char_links">{post.author?.name}</Link>
                            <span>{new Date(post.created_at).toLocaleString('ru-RU', timeOptions)} </span>
                            <Link className="article__info_char_links"><FontAwesomeIcon icon={faComment} size="lg" /> Оставить комментарий</Link>
                        </div>
                        
                        <div className="article__info_text">{post.text}</div>
                        <button onClick={togglePostLike}>
                            <span>Понравилось? </span>
                            <span className="product__like" onClick={togglePostLike}>{isLiked 
